...
HD_PWD='C:/Users/prana/Documents/Projects/FPGA-Soc/lcd_control_ps/lcd_control_ps.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_control_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_control_wrapper.tcl -notrace
