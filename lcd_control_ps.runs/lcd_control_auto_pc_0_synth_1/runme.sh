...
HD_PWD='C:/Users/prana/Documents/Projects/FPGA-Soc/lcd_control_ps/lcd_control_ps.runs/lcd_control_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_control_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_control_auto_pc_0.tcl
