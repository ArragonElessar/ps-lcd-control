...
HD_PWD='C:/Users/prana/Documents/Projects/FPGA-Soc/lcd_control_ps/lcd_control_ps.runs/lcd_control_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_control_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_control_axi_gpio_0_3.tcl
